...
ALLOWED_HOSTS = ['culturalCenters.pythonanywhere.com', "localhost", "127.0.0.1"]
...
ROOT_URLCONF = 'culturalCenters.urls'
...
WSGI_APPLICATION = 'culturalCenters.wsgi.application'
